...
Public Class Form_NewGame
    ...
    Private Sub Button_Play_Click(sender As System.Object, e As System.EventArgs) Handles Button_Play.Click
        If ComboBox_Faction.Text <> "" Then
            ...
            Form_Play.TurnReport_Log_Battles.Width = PanelSize
            Form_Play.TurnReport_Log_Battles.Height = Form_Play.GameScreen.Height - Form_Play.TurnReport_Log_Battles.Location.Y
    ...
    Private Sub Form_NewGame_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
